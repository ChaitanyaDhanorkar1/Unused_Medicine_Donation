# Generated by Django 4.0.1 on 2022-04-09 13:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='DonationModel',
            fields=[
                ('donate_id', models.IntegerField(default=enum.auto, primary_key=True, serialize=False)),
                ...
                ('donation_date', models.DateField(default=datetime.datetime(2022, 4, 9, 18, 36, 8, 35211))),
                ('expiry_date', models.DateField(default=datetime.datetime(2022, 4, 9, 18, 36, 8, 35211))),
            ],
        ),
        migrations.CreateModel(
            name='Entry',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medicine_name', models.CharField(default='Medicine', max_length=100)),
                ('medicine_quantity', models.IntegerField(default=0)),
                ('expiry_date', models.DateField(default=datetime.datetime(2022, 4, 9, 18, 36, 8, 36216))),
            ],
        ),
        migrations.CreateModel(
            name='RequestModel',
            fields=[
                ...
                ('medicine_name', models.CharField(default='Medicine', max_length=100)),
                ('medicine_quantity', models.IntegerField(default=0)),
                ('request_date', models.DateField(default=datetime.datetime(2022, 4, 9, 18, 36, 8, 36216))),
            ],
        ),
    ]
