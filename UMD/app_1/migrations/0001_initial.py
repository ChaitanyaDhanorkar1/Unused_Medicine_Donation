    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('donation_date', models.DateField(default=datetime.datetime(2022, 4, 8, 12, 3, 50, 548577))),
                ('expiry_date', models.DateField(default=datetime.datetime(2022, 4, 8, 12, 3, 50, 548577))),
            ],
        ),
        migrations.CreateModel(
            name='Entry',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medicine_name', models.CharField(default='Medicine', max_length=100)),
                ('medicine_quantity', models.IntegerField(default=0)),
                ('request_date', models.DateField(default=datetime.datetime(2022, 4, 8, 12, 3, 50, 548577))),
            ],
        ),
    ]
